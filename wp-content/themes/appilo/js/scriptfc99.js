(function($) {
	...
	function handlePreloader() {
		if($('.topapp-main .preloader').length){
			$('.topapp-main .preloader').delay(200).fadeOut(500);
		}
	}
	/* ==========================================================================
	...
	function topappcount() {
		if ($('.topapp-main .count-text').length) {
...
$(window).load(function () {
	...
	// Team Carousel
	if ($('.topapp-main .team-carousel').length) {
	...
	//Tabs Box
	if($('.topapp-main .tabs-box').length){
		$('.topapp-main .tabs-box .tab-buttons .tab-btn').on('click', function(e) {
			e.preventDefault();
